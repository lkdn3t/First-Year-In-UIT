...
Date   Candidate::getBirth()                  { return Birth;      }
float  Candidate::getMathScore()              { return MathScore;  }
float  Candidate::getLiterScore()             { return LiterScore; }
float  Candidate::getEngScore()               { return EngScore;   }
